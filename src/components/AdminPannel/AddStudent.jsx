                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-xl-6">
                                    <div className="card-body p-md-5 text-black">
                                        <h3 className="mb-5 text-uppercase">Add New Student </h3>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6 mb-4">
                                                <div className="form-outline">
                                                    ...
                                                    <label className="form-label" for="form3Example1n">Father's name</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-outline mb-4">
                                            ...
                                            <label className="form-label" for="form3Example99">Class</label>
                                        </div>
