                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col-xl-6">
                                            <div className="card-body p-md-5 text-black">
                                                <h3 className="text-uppercase">Add new Teacher</h3><label className='mb-5 '>Fill out the form carefully for registration</label>
                                                ...
                                                <div className="d-flex justify-content-end pt-3">
                                                    ...
                                                    <button type="button" className="btn btn-dark btn-lg ms-2">Submit form</button>
                                                </div>
