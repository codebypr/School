...
import h2 from '../MyImages/h2.jpg';
        ...
        <>
            ...
            <div className="container-fluid mt-5 mb-5">
                ...
                <div className="container pt-3">
                    ...
                    img={<BiArch className='w-100' style={{ fontSize: '100px', color: 'yellow' }} />}
                    text={`text-center`}/>
                    ...
                    title={`TOP Ranking`} 
                    img={<BiBuilding className='w-100' style={{ fontSize: '100px', color: 'yellow' }} />}
                    text={`text-center`}/>
                    ...
                    img={<BiDoorOpen className='w-100' style={{ fontSize: '100px', color: 'yellow' }} />}
                    text={`text-center`}/>
                    ...
                    img={<BiBulb className='w-100' style={{ fontSize: '100px', color: 'yellow' }} />}
                    text={`text-center`}/>
                        ...
                        <div className="col-lg-4">
                            <div className="card ">
                                <div className="card-body"> 
                                    ...
                                    <h5 className="card-title">Shruti Sethi</h5>
